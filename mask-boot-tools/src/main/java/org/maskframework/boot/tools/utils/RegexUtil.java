...
import static org.maskframework.boot.tools.utils.NationalityUtil.getAreaCodeAll;
...
public class RegexUtil {
    ...
    public static int chineseLength(String str) {
        ...
        if (StringUtil.notEmptyEnhance(str)) {
    ...
    public static String cutStringFromChar(String str1, String str2, int offset) {
        if (StringUtil.isEmptyEnhance(str1)) {
            return "";
        }
    ...
    public static boolean isContinuousNum(String str) {
        if (StringUtil.isEmptyEnhance(str)) {
            return false;
        }
        if (!isNumber(str)) {
            return true;
